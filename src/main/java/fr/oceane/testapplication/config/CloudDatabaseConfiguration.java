package fr.oceane.testapplication.config;
...
@Configuration
@EnableMongoRepositories("fr.oceane.testapplication.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("fr.oceane.testapplication.config.dbmigrations");
